ShopifyApp.configure do |config|
  ...
  config.old_secret = ''
  config.scope = 'read_products, write_products, read_product_listings, read_customers, write_customers, read_inventory, write_inventory,read_orders, write_orders' # Consult this page for more scope options:
